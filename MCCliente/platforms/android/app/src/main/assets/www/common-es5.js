...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var iosTransitionAnimation = function () { return __webpack_require__.e(/*! import() | ios-transition-836e46fb-js */ "ios-transition-836e46fb-js").then(__webpack_require__.bind(null, /*! ./ios.transition-836e46fb.js */ "./node_modules/@ionic/core/dist/esm/ios.transition-836e46fb.js")); };
            var mdTransitionAnimation = function () { return __webpack_require__.e(/*! import() | md-transition-5091809d-js */ "md-transition-5091809d-js").then(__webpack_require__.bind(null, /*! ./md.transition-5091809d.js */ "./node_modules/@ionic/core/dist/esm/md.transition-5091809d.js")); };
        ...
        /***/ "./src/app/api/authentication.service.ts": 
        /*!***********************************************!*\
          !*** ./src/app/api/authentication.service.ts ***!
          \***********************************************/
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AuthenticationService = /** @class */ (function () {
                function AuthenticationService(nativeStorage, httpNative) {
                    this.nativeStorage = nativeStorage;
                    this.httpNative = httpNative;
                    this.url = 'https://us-central1-machinecare-17c7a.cloudfunctions.net/api';
                    this.resp = {};
                    this.headers = {};
                    this.headers = {
                ...
                AuthenticationService.prototype.getLogin = function (data) {
                    var resp = {};
                    return this.httpPost(this.url + '/login', data);
                };
                AuthenticationService.prototype.setResponse = function (data) {
                    this.resp = data;
                };
                AuthenticationService.prototype.getResponse = function () {
                    return this.resp;
                };
                AuthenticationService.prototype.getUrlClientPost = function (api, data) {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    ...
                                    return [2 /*return*/, this.httpPost(this.url + api, data)];
                            }
                        });
                    });
                };
                AuthenticationService.prototype.getUrlClientGet = function (api, data) {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var tok;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    ...
                                    console.log("tok : " + tok);
                                    this.headers.authorization = "Bearer " + tok;
                                    return [2 /*return*/, this.httpGet(this.url + api, data)];
                            }
                        });
                    });
                };
                AuthenticationService.prototype.httpPost = function (url, data) {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var self, valor;
                        var _this = this;
                        return __generator(this, function (_a) {
                ...
                AuthenticationService.prototype.httpGet = function (url, data) {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var self, valor;
                        return __generator(this, function (_a) {
                            self = this;
                ...
                AuthenticationService.prototype.setToken = function (data) {
                    this.nativeStorage.setItem('token', data)
                        .then(function (data) { return console.log('Stored first item!', data); }, function (error) { return console.error('Error storing item', error); });
                };
                AuthenticationService.prototype.getToken = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, this.nativeStorage.getItem('token')
                                        .then(function (data) {
