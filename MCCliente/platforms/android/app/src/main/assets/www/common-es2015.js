...
let AuthenticationService = class AuthenticationService {
    constructor(nativeStorage, httpNative) {
    ...
    setToken(data) {
        this.nativeStorage.setItem('token', data)
            .then((data) => console.log('Stored first item!', data), error => console.error('Error storing item', error));
    }
    getToken() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.nativeStorage.getItem('token')
                .then((data) => {
